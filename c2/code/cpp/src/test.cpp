 ...
 * - --classify flag to enable crater morphology classification (A/AB/B/BC/C)
 * - Uses ranking_features_multires.hpp for ranker features
 * - Final timing and memory reporting
 * 
 * Usage:
 *   ./test --raw-dir /path/to/images --model /path/to/model.onnx [--polar] [--classify] [--tile-size 544x416]
 */
...
#include "../include/lightgbm_ranker.h"   // Auto-generated LightGBM ranker model (pure C)
